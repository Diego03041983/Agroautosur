...
export function SearchPanel({ compact = false }: { compact?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div className={compact ? "p-3 sm:p-5" : "p-4 sm:p-5"}>
        <div className="grid gap-3 lg:grid-cols-[1fr_auto]">
          <label className="flex min-h-14 items-center gap-3 rounded-xl border border-[#152018]/12 bg-white px-4 shadow-[inset_0_1px_0_rgba(21,32,24,0.04)] focus-within:border-[#1f6b43] focus-within:ring-4 focus-within:ring-[#1f6b43]/10 sm:min-h-16">
          ...
          <button className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-[#d6a82f] px-6 text-sm font-black text-[#152018] shadow-[0_12px_28px_rgba(214,168,47,0.22)] transition hover:bg-[#e4bd54] sm:min-h-16">
        ...
        {compact ? (
          <>
            <details className="mt-3 rounded-xl border border-[#152018]/10 bg-[#f8faf6] p-3 lg:hidden">
              <summary className="cursor-pointer list-none text-sm font-black text-[#152018]">
                Filtros avanzados
              </summary>
              {filters}
            </details>
