      ...
      <main className="aas-surface mx-auto grid min-h-[74vh] w-full max-w-5xl gap-6 px-4 py-10 sm:px-6 md:grid-cols-[0.9fr_1fr] md:items-center lg:px-8">
        <section className="rounded-2xl bg-[#101713] p-6 text-white shadow-[0_20px_70px_rgba(21,32,24,0.18)]">
          ...
          <p className="mt-4 text-sm leading-6 text-white/66">
            Este acceso debe validar usuarios administrativos, roles y permisos antes de permitir CRM, backoffice, analítica y aprobaciones. La interfaz está lista; falta conectar bloqueo real por middleware y Supabase Auth.
          </p>
        ...
        <form className="w-full rounded-xl border border-[#152018]/10 bg-white p-6 shadow-[0_18px_56px_rgba(21,32,24,0.14)]">
          ...
          <p className="mt-4 text-xs leading-5 text-[#667062]">
            Estado actual: formulario visual preparado. Próximo paso: conectar login real, sesión, middleware y validación por rol.
          </p>
        </form>
      </main>
    </>
